...
На рисунке 1 представлена диаграмма классов.
 ...
 <img width="471" height="239" alt="image" src="https://github.com/user-attachments/assets/0d8e2a7e-8bbb-435f-8471-d90d0b62a9a0" />

Рисунок 1 – Диаграмма классов

	На рисунке 2 представлена диаграмма вариантов использования.
 <img width="488" height="345" alt="image" src="https://github.com/user-attachments/assets/e459e195-eccc-49f6-908c-911359965eef" />
...
На рисунке 4 представлена диаграмма последовательности процесса заказа товара. 
 <img width="468" height="320" alt="image" src="https://github.com/user-attachments/assets/13025452-2f43-4ebf-89ef-cfc2dd8979ea" />

Рисунок 4 – Диаграмма последовательности процесса заказа товара

На рисунке 5 представлена диаграмма развертывания. 
<img width="379" height="270" alt="image" src="https://github.com/user-attachments/assets/491c1e5a-a6af-4689-9cfd-af09a4a07248" />
